      ...
      {isAuthenticated && (
        <div className="p-4 border-t border-gray-200">
          <button
            ...
            className="w-full flex items-center justify-center px-4 py-3 text-gray-600 hover:text-red-600 hover:bg-red-50 rounded-lg transition-all duration-200 font-medium cursor-pointer"
          >
