          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="max-w-3xl mx-auto">
              <div className="rounded-2xl border-2 border-indigo-500 p-8 bg-gradient-to-b from-white to-indigo-50 relative overflow-hidden">
                ...
                <Link
                  href="/auth/signup"
                  className="block w-full py-3 px-4 rounded-full text-center bg-gradient-to-r from-indigo-500 to-purple-600 text-white font-medium hover:shadow-lg transition-all cursor-pointer"
                >
                  Join Beta Program
                </Link>
              </div>
