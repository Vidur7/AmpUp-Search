    ...
    <div className="min-h-screen bg-gray-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <div className="mt-3 text-center text-sm text-gray-600">
          ...
          <p>You can still use the extension for basic analysis without an account!</p>
          <p className="text-xs mt-1">(Limited to 5 detailed analyses)</p>
        </div>
      </div>
              ...
              <div>
                <button className="w-full inline-flex justify-center py-2 px-4 border border-gray-300 rounded-md shadow-sm bg-white text-sm font-medium text-gray-500 hover:bg-gray-50">
                  ...
                  <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M12.545,12.151L12.545,12.151c0,1.054,0.855,1.909,1.909,1.909h3.536c-0.367,1.719-1.159,3.25-2.27,4.401 c-1.647,1.647-3.924,2.667-6.436,2.667c-5.042,0-9.125-4.083-9.125-9.125s4.083-9.125,9.125-9.125c2.512,0,4.789,1.02,6.436,2.667 c0.861,0.861,1.541,1.891,1.995,3.026h-3.93c-0.354-0.454-0.813-0.813-1.335-1.037c-0.683-0.293-1.426-0.456-2.211-0.456 c-3.141,0-5.686,2.545-5.686,5.686c0,3.141,2.545,5.686,5.686,5.686C11.169,13.75,12.545,12.151,12.545,12.151z" />
                  </svg>
                </button>
              </div>
